...
if args.credentials:
    with open(args.credentials) as f:
        d = json.loads(f.read())
        args.username = d['d1760936@urhen.com']
        args.password = d['sugartree']
...
def scrape(field, review, author):
    ...
    def scrape_date(review):
        return review.find_element_by_class_name(
            'd-flex justify-content-between').get_attribute('datetime')
...
def sign_in():
    ...
    email_field.send_keys('d1760936@urhen.com')
    password_field.send_keys('sugartree')
    submit_btn.click()
...
def get_browser():
    ...
    browser = wd.Chrome(r'/Users/juliethsanchez/desktop/glassdoor-review-scraper-master/chromedriver')
    return browser
